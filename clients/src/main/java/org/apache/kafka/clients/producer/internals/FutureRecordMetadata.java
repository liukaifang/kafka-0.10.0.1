...
public final class FutureRecordMetadata implements Future<RecordMetadata> {
    ...
    public FutureRecordMetadata(ProduceRequestResult result, long relativeOffset, long timestamp, long checksum, int serializedKeySize, int serializedValueSize) {
        this.result = result;
